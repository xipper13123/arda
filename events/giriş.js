...
module.exports = async member => {
  ...
  const background = await Canvas.loadImage('https://cdn.discordapp.com/attachments/695590497426866206/695720467247399143/Selampak-Giris.png');
  ...
  ctx.drawImage(avatar, 112, 55, 110, 110);
     ...
     const attachment = new Discord.Attachment(canvas.toBuffer(), 'Selampak-giris.png');
